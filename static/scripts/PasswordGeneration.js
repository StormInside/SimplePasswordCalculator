...
class PasswordFromWords{

    constructor(wordList, hash, useSymbols, replace_to_symbols=true) {
            ...
            this.replace_to_symbols = replace_to_symbols
        ...
        modifyWords() {
            ...
            for (let i = 0; i < this.wordsCount; i++) {
                ...
                if (this.replace_to_symbols == true){
...
function test_words_password(){
    ...
    for (let i = 0; i < 10; i++) {
        ...
        o = new PasswordFromWords(wordList, buffer, true, false)
